package ariefbelajarteknologi.aop.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(* ariefbelajarteknologi.aop.service.HelloService.*(java.lang.String))")
    ...
    @Pointcut("execution(* ariefbelajarteknologi.aop.service.*.*(..))")
